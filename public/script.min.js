(function () {
  ...
  // Time windows (IST)
  // 5:45 PM – 5:50 PM  → 1065 – 1070
  // 7:05 PM – 7:20 PM  → 1145 – 1160
  // 7:30 PM – 7:45 PM  → 1170 – 1185

  return (
    (minutes >= 1065 && minutes <= 1070) ||
    (minutes >= 1145 && minutes <= 1160) ||
    (minutes >= 1170 && minutes <= 1185)
  );
}
